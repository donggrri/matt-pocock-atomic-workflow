...
3. PLAN/TASKS/REVIEW는 기본적으로 커밋하지 않는다. 슬러그 폴더(`.docs/<slug>/` 또는 하네스 `docs/<slug>/`)의 원본은 그대로 두고, 복사본만 `%USERPROFILE%/.pi/agent/matt-pocock-atomic-workflow/evidence/<YYYY-MM-DD>-<slug>/`에 둔다.
