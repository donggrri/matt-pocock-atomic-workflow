...
---
`~/.agents/skills/atomic-workflow/SKILL.md`를 읽고 Phase 5를 수행한다.
...
3. PLAN/TASKS/REVIEW는 기본적으로 커밋하지 않는다. 복사본만 `%USERPROFILE%/.pi/agent/g-workflow/evidence/<YYYY-MM-DD>-<slug>/`에 둔다.
